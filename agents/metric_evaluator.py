...
from agents.llm_client import BaseLLMClient, LLMResponse, LLMClientError
...
Your response MUST be in the following JSON format:
{
  ...
  "improvement_advice": "<specific, actionable advice>",
  "positive_examples": ["<example 1>", "<example 2>", ...],
  "improvement_examples": ["<example 1>", "<example 2>", ...]
}
"""
...
class MetricEvaluator:
    ...
    def _parse_response(self, response: LLMResponse, metric: Metric) -> MetricResult:
        ...
        try:
            ...
            if score < 1 or score > 5:
                self.logger.warning(f"Invalid score {score}, clamping to range 1-5")
    ...
    def _manual_parse_response(self, content: str) -> Dict[str, Any]:
        ...
        """
        self.logger.warning("Falling back to manual response parsing")
